...
<p><img src="https://raw.githubusercontent.com/3615pbn/Pierre-Bousin/master/portrait.jpg" style="float:left; padding: 20px; width:150px; height: 150px" alt="Portrait">Trentenaire originaire de Tours, j'ai d'abord été opticien en magasin avant de m'installer sur Paris et aider à la fondation du 1er opticien en ligne français en 2009, pour moi une vraie découverte du monde du Web. De part cette expérience, cela m'a amené par la suite à participer à la création d'une plateforme ecommerce Magento au sein du groupe Optic 2000 en portant le Service Client (process et management d'équipe) et la création des parcours utilisateurs spécialisés de ce secteur. Je me suis formé petit à petit en interne sur le référencement naturel pour actions sur les différents sites du groupe avec en plus un pilotage des campagnes Ads.</p>
<p>Avec la volonté de voir autre chose que le secteur de l'optique et de plonger un peu plus dans l'écosystème digital, j'ai basculé en agence pour devenir Chef de Projet SEO chez Blog Ecommerce. J'y ai aimé la variété des projets/plateformes (PrestaShop, WooCommerce, Oasis7,...) et la relation avec les différents partenaires, techniques comme clients. Vous retrouverez ci-dessous tous les détails de mes missions.</p>
...
<p>Etre au contact des développeurs a été pour moi un réel enrichissement lors de mes débuts dans le Web car ils savaient retranscrire des choses que j'avais moi-même du mal à schématiser. De plus au cours de ces 3 dernières années, j'ai été amené à réaliser de l'intégration basique sur des sites clients et j'ai pris un réel plaisir sur la partie production. Seulement, bidouiller c'est bien mais avoir un savoir-faire c'est mieux ! Je veux concrètement apprendre les langages et surtout des méthodes d'apprentissages pérennes.</p>
...
Ainsi, je vois l'opportunité de me spécialiser en tant que Développeur Full-Stack pour m'ancrer un peu plus dans l'écosystème local avec une volonté pour ma part de m'inscrire dans des projets de petites structures type PME/TPE et startups plutôt que des SSII.</p>
<p>Ainsi, c'est pour toutes ces raisons que je souhaite participer à la prochaine session CEFIM pour devenir Développeur Web.</p>
...
<p>Mon épouse est créatrice de Robe de Mariée et j'ai réalisé un site vitrine sous Wordpress pour mettre en valeur ses créations et communiquer sur ces dernières actualités. J'agis aussi sur son référencement naturel bien évidemment et anime quelques campagnes Facebook Ads ciblée. <a href="https://www.lafilledutailleur.fr/" target="blank" title="La Fille du Tailleur">Voir le site</a></p>
...
<p style="margin-top: 15px;">Pour moi le plus beau sport du monde, même si j'aime aussi voir du volley et du rugby. Si des amateurs sont ici présents, à découvrir ce cycle de vidéos sur <a href="https://www.youtube.com/channel/UCANaa23W9dzac8iL_fGGfPw/featured" target="blank" title="Page Youtube TBNL">les plus grands légendes NBA</a> et toute la communauté <a href="http://trashtalk.co/" target="blank" title="Trashtalk">Trashtalk</a>.</p>
